    ...
    public class Config
    {
        ...
        private void setupConfigVarDict()
        {
            ...
            configVarsDefault = new Dictionary<String, Object>()
            {
                ...
                { "customAirMailSound", null },
                { "customBluePlateSound", null },
                { "customHeadShotSound", null },
                
                { "customStreak1", null }, { "customStreak2", null }, { "customStreak3", null }, { "customStreak4", null }, { "customStreak5", null },
                { "customMultiKill1", null }, { "customMultiKill2", null }, { "customMultiKill3", null }, { "customMultiKill4", null }, { "customMultiKill5", null },
                { "customFirstBlood", null }, { "customHeadShotKill", null }, { "customArtilleryShot", null }, { "customMeleeKill", null },
                { "customRoadKill", null }, { "customFastGrab", null },

                { "customFlagBlueGrab", null }, { "customFlagRedGrab", null },
                { "customFlagBluePickup", null }, { "customFlagRedPickup", null },
                { "customFlagBlueCapture", null }, { "customFlagRedCapture", null },
                { "customFlagBlueReturn", null }, { "customFlagRedReturn", null },
                { "customFlagBlueDrop", null }, { "customFlagRedDrop", null },
