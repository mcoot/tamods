...
module.name                = "Basic_Rectangle"  -- This HAS to be the same as the filename minus the trailing .lua
module.opts                = {}
...
function module.draw(res_x, res_y)
	...
	drawRect(xpos, ypos, xpos + module.opts.Width, ypos + module.opts.Height, module.opts.Color)
end
