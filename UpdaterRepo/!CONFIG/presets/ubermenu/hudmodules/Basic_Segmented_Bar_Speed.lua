...
module.name                = "Basic_Segmented_Bar_Speed"  -- This HAS to be the same as the filename minus the trailing .lua
module.opts                = {}
...
module.opts.Full           = rgba(255,0,0,255)
module.opts.Low            = rgba(255,255,255,255)
